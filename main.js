...
body.style.cssText =
  "background-color :#eee; height:60px;width:100vw;display:flex;justify-content:space-evenly;align-item:center;height:1500px;";
...
mainContent.style.cssText =" width:80%;height:auto;margin:90px auto;display:flex;flex-wrap: wrap;justify-content :center;"
...
function addingElementsMain() {
  ...
  for(let i =1; i<= 15; i++ ) {
    ...
    productsCard.style.cssText =" background-color:#e8e8e8; width:320px;height:320px;padding :10px;margin :10px auto;box-shadow:0 0 10px #00000069;display:flex;align-items:center;justify-content:center;flex-direction: column;"
